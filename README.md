...
- ```http://ns.nuke24.net/TEF/isFileEntry``` - true if this entry was found at the beginning of a file before any `=` lines
...
- ```http://ns.nuke24.net/TEF/EntryOpener``` - a "```=<type> <id...>```" line.
  ...
  - ```http://ns.nuke24.net/TOGVM/sourceLocation``` - where did this come from?
...
- ```http://ns.nuke24.net/TEF/ContentChunk``` - a chunk of file or entry content.
  ...
  - ```http://ns.nuke24.net/TOGVM/sourceLocation``` - where did this come from?
- ```http://ns.nuke24.net/TOGVM/SourceLocation``` (defined by [TOGVM-Spec/RDF-VOCAB.tef](https://github.com/TOGoS/TOGVM-Spec/blob/master/RDF-VOCAB.tef))
